...
class Decoder : public Component
{
  public:
    ...
    bool   exist;
    int    num_in_signals;
    double C_ld_dec_out;    // Alireza: Cload for WL (or WWL in 8T and 10T SRAM cell)
    double C_ld_dec_out_rd; // Alireza: Cload for RWL for 8T and 10T
    ...
    double sigma_delay_wl_driver; // sigma of the delay of the WL (or WWL) driver
    double sigma_delay_rwl_driver; // sigma of the delay of the RWL driver
    powerDef power;
    powerDef power_decoder; // save the value of the power of the decoder
    powerDef power_wordline; // save the value of the power of the WL (or WWL and RWL)
    bool   fully_assoc;
    bool   is_dram;
